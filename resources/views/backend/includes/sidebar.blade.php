                ...
                <div class="app-sidebar">
                    <div class="side-header">
                        <a class="header-brand1" href="{{ route('home') }}">
                            <img src="{{ asset('/') }}images/logo-white.png" class="header-brand-img desktop-logo"
                                alt="logo">
                            <img src="{{ asset('/') }}images/favicon.png" class="header-brand-img toggle-logo"
                                alt="logo">
                            <img src="{{ asset('/') }}images/favicon.png" class="header-brand-img light-logo"
                                alt="logo">
                    ...
                    <div class="main-sidemenu mt-4">
                        ...
                        <ul class="side-menu">
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    <li><a href="{{route('product.create')}}" class="slide-item">Add
                                            Product</a></li>
                                    <li><a href="{{route('product.index')}}" class="slide-item">Manage
                                            Product</a></li>
                                </ul>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                    ...
                                    <span class="side-menu__label">Category</span><i
                                        class="angle fa fa-angle-right"></i>
                                </a>
                                <ul class="slide-menu">
                                    <li><a href="{{route('category.create')}}" class="slide-item">Add Category</a>
                                    </li>
                                    <li><a href="{{route('category.index')}}" class="slide-item">Manage Category</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    <li><a href="{{route('subcategory.create')}}" class="slide-item">Add
                                            Sub-Category</a></li>
                                    <li><a href="{{route('subcategory.index')}}" class="slide-item">Manage
                                            Sub-Category</a></li>
                                </ul>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                    ...
                                    <span class="side-menu__label">Brands</span><i
                                        class="angle fa fa-angle-right"></i></a>
                                <ul class="slide-menu">
                            ...
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                    ...
                                    <span class="side-menu__label">Units</span><i
                                        class="angle fa fa-angle-right"></i></a>
                                <ul class="slide-menu">
                                    <li><a href="{{route('unit.create')}}" class="slide-item">Add Units</a></li>
                                    <li><a href="{{route('unit.index')}}" class="slide-item">Manage Units</a></li>
                                </ul>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                    ...
                                    <span class="side-menu__label">Order</span><i
                                        class="angle fa fa-angle-right"></i></a>
                                <ul class="slide-menu">
                            ...
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                    ...
                                    <span class="side-menu__label">Customers</span><i
                                        class="angle fa fa-angle-right"></i></a>
                                <ul class="slide-menu">
                                    <li><a href="#" class="slide-item">Manage Customers</a></li>
                                </ul>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="#">
