...
<head>
    ...
    <meta name="description" content="Ninico - Admin Dashboard">
...
<body class="ltr login-img">
        ...
        <div>
            ...
            <div class="col col-login mx-auto text-center">
                <a href="{{ route('index') }}" class="text-center">
                    <img src="{{ asset('/') }}images/favicon.svg" class="header-brand-img" alt="">
                </a>
            </div>
    ...
    <script src="{{ asset('/') }}admin/admin/assets/plugins/p-scroll/perfect-scrollbar.js"></script>

    <!-- STICKY JS -->
    <script src="{{ asset('/') }}admin/admin/assets/js/sticky.js"></script>
