                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="country-select">
                                    ...
                                    <select>
                                        ...
                                        <option value="audi5" selected>Bangladesh</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="checkout-form-list">
                                    ...
                                    <input type="text" placeholder="Street address" name="delivery_address" />
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="checkout-form-list">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="country-select">
                                            <label>Country <span class="required">*</span></label>
                                            <select>
                                                <option value="volvo" selected>bangladesh</option>
                                                <option value="saab">Algeria</option>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="your-order mb-30 ">
                            ...
                            <table>
                                ...
                                <tbody>
                                    ...
                                    <tr class="cart_item">
                                        ...
                                        <td class="product-total">
                                            <span class="amount">BDT {{$totalPrice = $item->price * $item->qty}}</span>
                                        </td>
                                    </tr>
                                ...
                                <tfoot>
                                    <tr class="cart-subtotal">
                                        <th>Cart Subtotal</th>
                                        <td><span class="amount">BDT {{$sum}}</span></td>
                                    </tr>
                                    <tr class="cart-subtotal">
                                        <th>tax</th>
                                        <td><span class="amount">BDT {{$tax=$sum*.15}}</span></td>
                                    </tr>
                                    <tr class="shipping">
                                        <th>Shipping</th>
                                        <td>
                                            <ul>
                                                <li>
                                                    ...
                                                    <label>
                                                        Flat Rate: <span class="amount">BDT {{$shipping = 100}}</span>
                                                    </label>
                                                </li>
                                                <li>
                                                    <input type="radio" name="shipping" />
                                                    <label>COD: <span class="amount">BDT
                                                            {{$shipping = 0}}</span></label>
                                                </li>
                                            </ul>
                                        </td>
                                    </tr>
                                    <tr class="order-total">
                                        <th>Order Total</th>
                                        <td><strong><span class="amount">BDT
                                                    {{$orderTotal = $sum+$shipping}}</span></strong>
                                        </td>
                                    </tr>
                                </tfoot>
                            </table>
                        ...
                        <div class="payment-method">
                            <!-- <div class="accordion" id="checkoutAccordion">
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="paypal" class="accordion-collapse collapse" aria-labelledby="paypalThree"
                                        data-bs-parent="#checkoutAccordion">
                                        <div class="accordion-body">
                                            Pay via Bkash, Nogod, Rocket; you can pay with your credit card if you don’t
                                            have a payee account.
                                        </div>
                                    </div>
                                </div>
                            </div> -->
                            ...
                            <li>
                                <input type="radio" value="Online" name="payment_method">
