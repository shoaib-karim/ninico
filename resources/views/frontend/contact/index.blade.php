        ...
        <div class="row">
                ...
                <div class="tpcontact__right mb-40">
                    <div class="tpcontact__shop mb-30">
                        ...
                        <div class="tpshop__info">
                            <ul>
                                <li><i class="fal fa-map-marker-alt"></i> <a href="#">Mirpur-10, Dhaka</a></li>
                                <li>
                                    <i class="fal fa-phone"></i>
                                    <a href="tel:0123456789">+880 (19) 6156 7558</a>
                                </li>
                                <li>
            ...
            <div class="col-lg-8 col-12">
                <div class="tpcontact__form">
                    ...
                    <form action="{{asset('/')}}assets/mail.php" id="contact-form" method="POST">
                        <div class="row">
                            <div class="col-lg-6">
